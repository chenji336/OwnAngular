...
describe('parse',function(){
	...
	it('can parse scientific notation with a negative coefficient',function(){
	...
	it('will not parse invalid scientific notation',function(){
		// 这个有问题，到时候在看下，跟parse a unary -有冲突
	...
	// Parsing Objects
	// 都是从最简单的例子出来，然后在慢慢的扩展开来，很舒服，比如先空在有。。
	...
	it('will parse a non-empty object',function(){
		var fn=parse('{"a key": 1,\'anohter-key\':2}');
		expect(fn()).toEqual({'a key':1,'anohter-key':2});
	});

	it('will parse an object with identifier key',function(){
	...
	it('does not allow calling the aliased functnion constructor',function(){
	...
	it('does not allow calling functions an Object',function(){
	...
	// Multiplicative Operates
	it('parses a multiplicative',function(){
	...
	it('parses several multiplicative',function(){
